...
Moreover, Figma engineering upended my understanding of what working on web client-side could mean. I used to think that writing complicated and responsive websites, caching the right resources, pagination, etc. was all. But at Figma, I got to think about sandboxing (plugins), virtual memory (wasm), file formats, error handling, compiling (cmake?!) and more OS concepts. There’s also a lot of exposure on graph algorithms and animations (e.g. winding rules, vector networks), like the interesting things you learned in college but never used in a job. I once wrote a binary search algorithm to optimize scrolling performance and I was so excited. I don’t think there exists another company I could join that has as many challenging problems condensed in as readable a codebase.
...
I took the GMAT in 2018, thinking that I might need it some day. I did well enough to probably get into any business school based on scores alone, but the timing wasn’t right… I was just starting to get a hang of Figma. Even so, that desire to know something other than coding remained. Typically, people would get an MBA or something, but ‘management’ is too vague for me. I needed something concrete with what I’m learning, like being able to read financial news or understand my own finances. It just happens that I am about a 15min drive from CU Boulder, where there’s a Master’s in Finance program that’s only 9 months long. I promptly enrolled, expecting to graduate May 2024. After this, I still want to get a job in tech, just because coding is still fun for me, and pays more 😛 If anybody’s hiring H2 2024, hmu!
